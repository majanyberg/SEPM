...
class ClockGame:
    ...
    def load_ui(self):
        ...
        self.title_label = tk.Label(self.menu_frame, text="CLOCK GAME", 
                                    font=(self.custom_font_family, 24), fg="black", bg="#dbdbdb")
        ...
        self.return_button = tk.Button(self.menu_frame, text="Return to Main Menu",
                                       font=(self.custom_font_family, 14), bg="#8B0000", fg="white",
                                       relief="ridge", bd=3, command=self.return_to_main_menu_callback)
    ...
    def show_leaderboard(self): # Are we skipping this functionality?
    ...
    def reset_game(self): # Are we skipping this functionality?
...
if __name__ == "__main__":
    ...
    app = ClockGame(root)  # Initialize the game UI
