...
class Level1UI:
    ...
    def create_clock_label(self):
        self.clock_image = tk.PhotoImage(file=self.clock_image)
    ...
    def create_option_buttons(self):
        self.option_buttons = []
        for i in range(4):
            button = tk.Button(self.level_frame, text="", font=self.font, bg="gray", fg="white", 
                               relief="ridge", bd=3, command=lambda i=i: self.check_answer(i))
    ...
    def load_question(self):
        ...
        options = ["kvart över fem", "tio i tre", "halv sju", "fem över åtta"] # get options from backend
